          ...
          setComments(prevComments => 
            prevComments.map(c => 
              c.id === optimisticComment.id ? {
                ...
                author: normalizedComment.author || normalizedComment.user,
                user: normalizedComment.user || normalizedComment.author,
                ...
                <View key={comment.id}>
                  ...
                  <View style={styles.commentContent}>
                    <View style={styles.commentHeader}>
                      <Text style={styles.commentAuthor}>{comment.author.name || comment.author.username || 'Anonymous'}</Text>
                      ...
                      <View style={styles.repliesContainer}>
                        {comment.replies.map((reply, index) => (
                          <View key={reply.id} style={[styles.commentContainer, styles.replyContainer]}>
                            ...
                            <View style={styles.commentContent}>
                              <View style={styles.commentHeader}>
                                <Text style={styles.commentAuthor}>{reply.author.name || reply.author.username || 'Anonymous'}</Text>
                              ...
                              {replyingTo === reply.id && (
                                <View style={styles.nestedReplyInputContainer}>
                                  <TextInput
                                    ...
                                    placeholder={`Reply to ${reply.author.name || reply.author.username || 'this reply'}...`}
                    ...
                    <View style={styles.replyInputSection}>
                      ...
                      <View style={styles.replyInputContainer}>
                        <TextInput
                          ...
                          placeholder={`Reply to ${comment.author.name || comment.author.username || 'this comment'}...`}
                          placeholderTextColor="#666"
                          value={replyText}
                          onChangeText={setReplyText}
                          multiline
