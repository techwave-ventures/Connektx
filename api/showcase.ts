...
export function normalizeShowcaseComment(comment: any): ShowcaseComment {
  const normalizedAuthor = {
    _id: comment.user?._id || comment.user?.id || comment.author?._id || comment.author?.id || '',
    id: comment.user?.id || comment.user?._id || comment.author?.id || comment.author?._id || '',
    name: comment.user?.name || comment.author?.name || comment.user?.username || comment.author?.username || 'Unknown User',
    profileImage: comment.user?.profileImage || comment.user?.avatar || comment.author?.profileImage || comment.author?.avatar || '',
    avatar: comment.user?.avatar || comment.user?.profileImage || comment.author?.avatar || comment.author?.profileImage || '',
    username: comment.user?.username || comment.author?.username || comment.user?.name || comment.author?.name || '',
  };
